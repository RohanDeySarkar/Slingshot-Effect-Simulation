...
pygame.display.set_caption("gravity slingshot effect")
...
def create_ship(location, mouse):
    t_x, t_y = location
    m_x, m_y = mouse
    # Reduce speed by dividing with a const val (100 in this case)
...
def main():
    ...
    while running:
        # speed of the while loop (60 in this case)
        clock.tick(FPS)
        ...
        if temp_obj_pos:
            ...
            # draw circle at mouse click pos
